/****************************************************************************************************
 * ElectricStovetopConstants.h  This file contains the defined constants for the Stovetop_Monitor
 *  project.  These constants are based upon the experiemental data gathered on a glass top
 *  electric stove during the spring of 2026.
 *
...
// timeouts for alarm
#define WARM_ALARM_TIME 65 // Minutes in WARM state before alarm
#define COOK_ALARM_TIME 40 // Minutes in COOK state before alarm
#define BURN_ALARM_TIME 5  // Minutes in BURN state before alarm
